...
@Component
@ManagedBean(name = "createArticleMassBean")
public class CreateArticleMassBean implements Serializable {
    ...
    private FilterBean filterBean = new FilterBean("createArticleMassBean",new Temp());
