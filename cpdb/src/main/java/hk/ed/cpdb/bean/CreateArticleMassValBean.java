...
public class CreateArticleMassValBean implements Serializable {
	...
	public void info(){
		FacesContext.getCurrentInstance().addMessage("msg1", new FacesMessage(FacesMessage.SEVERITY_INFO, "Info", "File Format Validation Passed"));
		FacesContext.getCurrentInstance().addMessage("msg2", new FacesMessage(FacesMessage.SEVERITY_INFO, "Info", "File Content Syntax Validation Passed"));
		FacesContext.getCurrentInstance().addMessage("msg3", new FacesMessage(FacesMessage.SEVERITY_WARN, "Warning!", "Article Data Content Validation - Partially Passed(4/9)"));
			}
